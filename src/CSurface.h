...
public:
	...
	static SDL_Texture* OnLoad(char* File, SDL_Renderer *renderer, int R, int G, int B);
	...
	*/
	...
	static void ClearTexture(SDL_Texture* texture, SDL_Renderer* renderer, SDL_Window* window);
};
